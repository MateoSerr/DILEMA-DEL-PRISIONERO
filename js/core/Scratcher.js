...
Scratcher.scratch = function(gotoID){
	console.log('🎬 Scratcher.scratch(' + gotoID + ')');
	console.log('🎬 localStorage ANTES de scratch:', localStorage.getItem('trustGameSave'));
	...
	.then(function(){
		console.log('🎬 Scratcher animación completa, navegando a:', gotoID || 'next');
		console.log('🎬 localStorage DESPUÉS de animación:', localStorage.getItem('trustGameSave'));
		if(gotoID){
